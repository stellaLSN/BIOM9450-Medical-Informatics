...
<head>
	...
	<title>Update Morning Diet/Exercise Round</title>
				...
				<form id="update_diet_round_record" name="update_diet_round_record"  method= "post" action="update_diet_round_record.php"> 
					<table class="edit_round_center">
						...
						<?php 
							...
							$get_diet_rec= "SELECT * FROM Diet WHERE (patient_id = '".$captured_patient_id."')  AND (diet_exercise_round = 'morning') AND (administer_date = '".$currentDate."')";
